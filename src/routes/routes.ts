...
import { contactUs, getSingleUser, login, register } from "../controllers/userController";
...
// admin Routes 
router.post("/api/admin/register", AdminProfile.single("profile_Image"), registerAdmin);
router.post("/api/admin/login", loginAdmin);
router.post("/api/addCategory", AdminToken, category);
router.post("/api/addSubCategory", AdminToken, subCategory);
router.post("/api/addproduct", AdminToken, Upload.single("img"), addProduct);
router.delete("/api/deleteproduct/:id", AdminToken, deleteProduct);
router.put("/api/updateproduct/:id", AdminToken, Upload.single("img"), updateProduct);
